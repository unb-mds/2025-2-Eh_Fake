...
const nextConfig = {
  images: {
    remotePatterns: [
      ...
      { protocol: 'https', hostname: "g1.globo.com" },
      { protocol: 'https', hostname: "www1.folha.uol.com.br" },
      { protocol: 'https', hostname: "s2-g1.glbimg.com" },
      { protocol: 'https', hostname: "static.cdn.pleno.news" },
      { protocol: 'https', hostname: "www.jornaldacidadeonline.com.br" },
      { protocol: 'https', hostname: "s02.video.glbimg.com" },
      { protocol: 'https', hostname: "revistagalileu.globo.com" },
      { protocol: 'https', hostname: "cdn.brasil247.com" },
      { protocol: 'https', hostname: "fotos.jornaldacidadeonline.com.br" },
      { protocol: 'https', hostname: 'jpimg.com.br' }, 
